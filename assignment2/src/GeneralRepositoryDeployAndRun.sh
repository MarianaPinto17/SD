...
sshpass -f password scp test/out/generalRepositoryDir.zip sd101@l040101-ws01.ua.pt:test/AirLift
...
sshpass -f password ssh sd101@l040101-ws01.ua.pt 'cd test/AirLift/generalRepositoryDir ; less log.txt'