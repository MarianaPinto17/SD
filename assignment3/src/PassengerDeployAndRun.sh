...
sshpass -f password ssh sd101@l040101-ws07.ua.pt 'cd test/AirLift/passengerDir ; java ClientSide.main.PassengerMain l040101-ws02.ua.pt 22105 l040101-ws03.ua.pt 22106 l040101-ws04.ua.pt 22107'
