...
sshpass -f password ssh sd101@l040101-ws03.ua.pt 'cd test/AirLift/destinationAirportDir ; java ServerSide.main.DestinationAirportMain 22106 l040101-ws01.ua.pt 22100'
